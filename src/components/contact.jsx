                ...
                <div className="right-contact">
                    ...
                    <form ref={form} onSubmit={handleSubmit(onSubmit)}>
                        <div className='form-errors'>
                            ...
                            ) : errors.subject ? (<span className="red">Please Enter Your Subject</span>) : errors.text ? (<span className="red">Please Enter Your Message</span>) : null}
                            {green && <span className='green'>Message sent !. Contact You soon 😊</span>}
                            {error && <span style={{ color: "red" }}>Error in Sending Message</span>}
                        </div>
                        ...
                        {!isSubmitting ? <button  className='btn-contact' type='submit'>
                            ...
                            <button disabled style={{cursor:"auto",pointerEvents:"none"}} type='submit'>
                                Sending ...</button>
                        }
                    </form>
                </div>
